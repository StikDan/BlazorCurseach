...
namespace BlazorCurseach.Migrations
{
    ...
    [Migration("20260110084607_TotalSumOrder")]
    partial class TotalSumOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorCurseach.Models.ItemCharacteristicValue", b =>
                {
                    b.Property<int>("idItemCharacteristicValue")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Идентификатор");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("idItemCharacteristicValue"));
                    ...
                    b.Property<int>("idValueCharacteristic")
                        .HasColumnType("int")
                        .HasComment("Айди значения характеристики для связи M:M (FK)");

                    b.HasKey("idItemCharacteristicValue")
                        .HasName("PRIMARY");

                    b.HasIndex(new[] { "idItem" }, "fk_ItemCharacteristicValue_Item1_idx");

                    b.HasIndex(new[] { "idValueCharacteristic" }, "fk_ItemCharacteristicValue_ValueCharacteristic1_idx");

                    b.ToTable("ItemCharacteristicValue", null, t =>
                        {
                            t.HasComment("Таблица для обеспечения связи N:M (Item <-> ValueCharacteristic)");
                        });
                });
            ...
            modelBuilder.Entity("BlazorCurseach.Models.Order", b =>
                {
                    ...
                    b.Property<int>("totalSum")
                        .HasColumnType("int")
                        .HasComment("Общая стоимость заказа");
            ...
            modelBuilder.Entity("BlazorCurseach.Models.OrderItemTemp", b =>
                {
                    b.Property<int>("idOrderItemTemp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Идентификатор связующей таблицы заказа и товара");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("idOrderItemTemp"));
            ...
            modelBuilder.Entity("BlazorCurseach.Models.ItemCharacteristicValue", b =>
                {
                    ...
                    b.HasOne("BlazorCurseach.Models.ValueCharacteristic", "idValueCharacteristicNavigation")
                        .WithMany()
                        .HasForeignKey("idValueCharacteristic")
                        .IsRequired()
                        .HasConstraintName("fk_ItemCharacteristicValue_ValueCharacteristic1");

                    b.Navigation("idItemNavigation");

                    b.Navigation("idValueCharacteristicNavigation");
                });
