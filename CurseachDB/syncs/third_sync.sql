...
CHANGE COLUMN `descOrder` `descOrder` VARCHAR(400) NULL DEFAULT NULL COMMENT 'Описание заказа' ;

ALTER TABLE `Marketplace`.`StatusOrder` 
CHANGE COLUMN `nameStatus` `nameStatus` VARCHAR(20) NOT NULL COMMENT 'Название статуса заказа' ;
...
CHANGE COLUMN `nameItem` `nameItem` VARCHAR(70) NOT NULL COMMENT 'Название товара' ,
CHANGE COLUMN `descItem` `descItem` VARCHAR(400) NOT NULL COMMENT 'Описание товара' ,
